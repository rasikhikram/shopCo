...
const TopSelling = () => {
  ...
  const handleImageClick = (product) => {
    navigate("/shop", { state: { product } }); // Pass product details to the shop page
  };
        ...
        {productsData.featuredProducts.map((product) => (
          <div key={product.id} className="text-center">
            <img
              ...
              className="w-full max-w-[300px] mx-auto cursor-pointer transition-transform transform hover:scale-105"
            />
